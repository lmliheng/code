...
disp(['第3组音爆分别对应检测设备A、B、C、D的序号：', num2str([2, sorted_results(1, 1:3)])]);

%% 第二步：明确ABCD分别为2332，作差计算EFG
...
disp(['第3组音爆分别对应检测设备A、B、C、D、E、F、G的序号 ', num2str([2, sorted_results(1, 1:3), min_col_indices(1:3)'])]);
